...
=========================
*/
func ExternalReferenceID() string {
	rand.Seed(time.Now().UnixNano())
	return fmt.Sprintf("MS%d", rand.Int63n(999999999999))
}
...
=========================
*/
func BalanceEnquiry(c *fiber.Ctx) error {
...
func Ministatemnet(c *fiber.Ctx) error {
	...
	req, _ := http.NewRequest(
		"POST",
		"https://api.instantpay.in/fi/aeps/miniStatement",
		bytes.NewBuffer(jsonData),
	)
...
func Cashwidroll(c *fiber.Ctx) error {
	...
	req, _ := http.NewRequest(
		"POST",
		"https://api.instantpay.in/fi/aeps/cashWithdrawal",
		bytes.NewBuffer(jsonData),
	)
